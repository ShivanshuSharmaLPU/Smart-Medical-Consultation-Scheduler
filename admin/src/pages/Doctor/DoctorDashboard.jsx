...
const DoctorDashboard = () => {
  ...
  const {currency,slotDateFormate,cancelAppointment,completeAppointment} = useContext(AppContext)
                 ...
                 {dashData.latestAppointments.map((item, index) => {
                   ...
                   <div className="flex items-center px-6 py-3 gap-3" key={index}>
                     ...
                     <div className="flex-1 text-sm">
                       ...
                       <p className="text-gray-800 font-medium">{slotDateFormate(item.slotDate)}</p>
                     </div>
                     {
          item.cancelled 
